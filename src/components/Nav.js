...
export const Nav = () => {
  ...
  return (
    <div className="shadow-lg w-full h-16 fixed top-0 left-0 z-50">
      <div className="md:flex justify-between bg-white py-5 px-7">
        <button
        ...
        <ul
          className={`md:flex md:items-center md:justify-end md:pb-0 pb-12 absolute md:static bg-white z-0 left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-300 ease-in ${
